...
public class BTNIngameMenuShortBar extends GuiButton
{
    String m_BtnName = "";
    ...
    public BTNIngameMenuShortBar(int buttonId, int x, int y, String buttonText)
    {
        super(buttonId, x, y, buttonText);
    }

    public BTNIngameMenuShortBar(int buttonId, int x, int y, float imageWidth, float imageHeight, String buttonText, String btnName) {
        super(buttonId, x, y, buttonText);
