...
public class BTNGameMenu extends GuiButton
{

    public BTNGameMenu(int buttonId, int x, int y, float imageWidth, String buttonText, String btnName)
    {
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY, float partialTicks)
    {
        ...
        BindTexture.bindTexture(new ResourceLocation(Reference.MODID, "textures/guis/menu/"+m_BtnName+ active + ".png"));
        drawTexture(this.x, this.y, m_btn_ImageWidth, m_btn_ImageWidth, 0, 0, 1, 1, 3, 1);
