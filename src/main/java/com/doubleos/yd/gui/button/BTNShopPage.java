...
public class BTNShopPage extends GuiButton
{
    ...
    float m_btn_ImageWidth = 18f;
    float m_btn_ImageHeight = 18f;



    public BTNShopPage(int buttonId, int x, int y, String buttonText)
    {
        super(buttonId, x, y, buttonText);
    }

    public BTNShopPage(int buttonId, int x, int y, float imageWidth, float imageHeight, String buttonText, String btnName)
    {
        super(buttonId, x, y, buttonText);
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY, float partialTicks)
    {
        ...
        BindTexture.bindTexture(new ResourceLocation(Reference.MODID, "textures/guis/shop/"+m_BtnName+ active + ".png"));
