...
public class BtnMoneySendMember extends GuiButton
{
    ...
    public BtnMoneySendMember(int buttonId, int x, int y, String buttonText)
    {
        super(buttonId, x, y, buttonText);
    }

    public BtnMoneySendMember(int buttonId, int x, int y, float imageWidth, float imageHeight, String buttonText, String memberName)
    {
        super(buttonId, x, y, buttonText);
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY, float partialTicks)
    {
        ...
        if(textureId == 0)
        {
            BufferedImage image = ImageBuffer.m_nameToBufferImage.get(m_BtnName);
        ...
        {
            drawTexture(this.x, this.y, m_btn_ImageWidth, m_btn_ImageHeight, 0, 0, 1, 1, 3, 1, 0.6f, 0.6f, 0.6f);
        }
        else
        {
