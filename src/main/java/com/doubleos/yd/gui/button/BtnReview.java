...
public class BtnReview extends GuiButton
{
    ...
    public BtnReview(int buttonId, int x, int y, String buttonText)
    {
        super(buttonId, x, y, buttonText);
    }

    public BtnReview(int buttonId, int x, int y, float imageWidth, float imageHeight, String buttonText, String btnName)
    {
        super(buttonId, x, y, buttonText);
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY, float partialTicks)
    {
        ...
        BindTexture.bindTexture(new ResourceLocation(Reference.MODID, "textures/guis/book/"+m_BtnName+ active + ".png"));
