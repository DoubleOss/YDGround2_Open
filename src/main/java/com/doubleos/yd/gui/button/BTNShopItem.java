...
public class BTNShopItem extends GuiButton
{

    public BTNShopItem(int buttonId, int x, int y, float imageWidth, String buttonText, ItemStack stack)
    {
        ...
        int m_btn_Height = (int) imageWidth;
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY, float partialTicks)
    {
        ...
        //minecraft.getRenderItem().renderItemOverlays(minecraft.fontRenderer, m_stack, (int) this.x, (int) this.y);
        if(active.equals("_select"))
        {
            GlStateManager.pushMatrix();
            {
                GlStateManager.scale(1.5f, 1.5f, 1.5f);
                RenderHelper.enableGUIStandardItemLighting();
                minecraft.getRenderItem().renderItemIntoGUI(m_stack, (int) (this.x/1.5f), (int) (this.y/1.5f));
            }
        ...
        else
        {
            GlStateManager.pushMatrix();
            {
                ...
                RenderHelper.enableGUIStandardItemLighting();
                minecraft.getRenderItem().renderItemIntoGUI(m_stack, (int) (this.x/1.7f), (int) (this.y/1.7f));
            }
            GlStateManager.popMatrix();
        }
