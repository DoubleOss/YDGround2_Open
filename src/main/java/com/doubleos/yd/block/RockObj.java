...
public class RockObj extends Block implements IHasModel, IObjModel
{
    ...
    public RockObj(String name, Material blockMaterialIn, boolean unbreaking)
    {
    ...
    {
        return new AxisAlignedBB(-0.5D, 0.0D, -0.5D, 1.5D, 2.0D, 1.5D);
    }
