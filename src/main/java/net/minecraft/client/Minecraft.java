...
public class Minecraft implements IThreadListener, ISnooperInfo
{
    ...
    public boolean m_jumpCancel = false;
    public boolean m_sprint = false;
    ...
    public void toggleFullscreen()
    {
        try
        {
            ...
            System.out.println(! (this.displayWidth == 1920 && this.displayHeight == 1080) || (this.displayWidth == 1280 && this.displayHeight == 720));
            ...
            if(m_currentView == 0)
            {
                ...
                m_currentView = 1;
                this.displayWidth = Math.max(1, 1920);
                this.displayHeight = Math.max(1, 1080);
            }
            else
            {
                try {
                ...
                m_currentView = 0;
                this.displayWidth = Math.max(1, 1280);
                this.displayHeight = Math.max(1, 720);
            ...
            {
                GuiMainMenu mainMenu = (GuiMainMenu)this.currentScreen;
                mainMenu.initGui();
            }
