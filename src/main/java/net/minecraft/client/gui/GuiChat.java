...
public class GuiChat extends GuiScreen implements ITabCompleter
{
    ...
    public void initGui()
    {
        ...
        this.inputField = new GuiTextField(0, this.fontRenderer, 4, this.height - 12, this.width/2 - 180, 12);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        {
            GlStateManager.translate(0, -140, 40);
            drawRect(2, this.height - 14, this.width/2 - 150, this.height - 2, Integer.MIN_VALUE);
